...
public class ExportFileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // TODO 1: Iterate through Enumeration of parameter names from the request object and put
        // TODO inside paramsMap each parameter send from request
...
//        paramsMap = Arrays.asList(request.getParameterNames()).stream().
