...
<script type="text/javascript">
    function exportFile() {
        ...
        if (username != null && username != "") {
            ...
            window.open("/servlet-app-day2/export?username=" + username + "&fileType=pdf&template=UsernameReport");
            ...
            // TIP: Remember that the application context it's named servlet-app
            window.open("/servlet-app-day2/export?fileType=pdf&template=UsernameReport");
        }
